...
| `<path>` (positional) | Yes | Absolute file path on the VM under /home/work or /tmp (e.g. /home/work/.openclaw/workspace/report.pdf). Hidden files and paths outside those roots cannot be shared. (string) |
